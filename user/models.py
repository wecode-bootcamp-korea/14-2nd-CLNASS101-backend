...
class User(models.Model):
    ...
    recently_view = models.ManyToManyField('product.Product', through='user.RecentlyView',
                                           related_name='product_view_user')
    user_product = models.ManyToManyField('product.Product', through='user.UserProduct',
                                          related_name='product_buy_user')
    product_like = models.ManyToManyField('product.Product', through='user.ProductLike',
                                          related_name='product_like_user')
    community_like = models.ManyToManyField('product.Community', through='product.CommunityLike',
